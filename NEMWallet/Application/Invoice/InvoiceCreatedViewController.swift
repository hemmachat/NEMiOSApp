...
final class InvoiceCreatedViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let invoiceAmount = NSMutableAttributedString(string: "\((Double(invoice.amount) / 1000000).format()) XEM" , attributes: [NSAttributedStringKey.font: UIFont.systemFont(ofSize: 16)])
